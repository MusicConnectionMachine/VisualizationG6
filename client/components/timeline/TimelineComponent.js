        ...
        const html = (
          <div>
            <div className={className} id={`timeline__body__itembox__${event.id}`}>
              ...
              <FeedbackComponent
                onLiked={this.handleFeedback.bind(this, event.id)} // eslint-disable-line
                onDisliked={this.handleFeedback.bind(this, event.id)} // eslint-disable-line
                onMarkedAsWrong={this.handleFeedback.bind(this, event.id)} // eslint-disable-line
              />
              <div
              ...
              >
                {
                  event.link ? <a href={event.link} target={event.linkType === 'external' ? '_blank' : '_self'}> { event.title } </a>
                    : event.title
                }
              </div>
            </div>
